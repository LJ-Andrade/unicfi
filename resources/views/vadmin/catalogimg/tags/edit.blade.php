...
@section('header')
	@component('vadmin.components.header')
		@slot('breadcrums')
			...
			<li class="breadcrumb-item"><a href="{{ route('catimg_tags.index')}}">Etiquetas del Catálogo</a></li>
			<li class="breadcrumb-item active">Edición de Etiqueta</li>
		@endslot
		@slot('actions')
			<div class="list-actions">
				<h2>Editando etiqueta de la galería: "{{ $tag->name }}"</h2>
				{{-- Edit --}}
